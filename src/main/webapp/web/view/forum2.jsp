...
<div class="main-forum">
    <div class="forum">
        <div class="title">
            <span class="t2"><a href="${pageContext.request.contextPath}/tie/sousou.do?mysle=0&page=1">咨询专区 </a></span><span class="t1"> / 结贴专区</span>
            <div class="range">
                <input type="button" id="b1" name="b1" value="查找">
            </div>
            <div class="range">范围：
                <select  name="mysle" id="mysle">
         ...
         <c:forEach items="${page.records}" var="res">
            <div class="forum1">
                <div class="text1">
                    ...
                    <c:if test="${res.dengji == '1'}">
                    <div class="quality level1">优</div>
                    </c:if>
                    <c:if test="${res.dengji == '2'}">
                    <div class="quality level2">良</div>
                    </c:if>
                    <c:if test="${res.dengji == '3'}">
                    <div class="quality level3">一般</div>
                    </c:if>
                     <c:if test="${res.dengji == '4'}">
                     <div class="quality level4">差</div>
                    </c:if>
            ...
            <c:if test="${page.totalpage > 1}">
                <ul class="pagination">
                    <li><a href="${pageContext.request.contextPath}/tie/sousou.do?page=1&keyword=${page.keyword}&mysle=${page.mySle}">&laquo;</a></li>
                    <c:forEach begin="${page.startPage}" end="${page.lastPage}" var="e">
                            <li><a href="${pageContext.request.contextPath}/tie/sousou.do?page=${e}&keyword=${page.keyword}&mysle=${page.mySle}">${e}</a></li>
                     </c:forEach>
                    <li><a href="${pageContext.request.contextPath}/tie/sousou.do?page=${page.totalpage<=0?1:page.totalpage}&keyword=${page.keyword}&mysle=${page.mySle}">&raquo;</a></li>
                </ul>
                </c:if>
            </div>
            </c:if>
            ...
            <div class="input_forum">
                <div class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="form-control" name="mysle1" id="mysle1">
...
$().ready(function(){
   ...
   function SelectChange(){
	   var selectValue = $("#mysle").val();
	   var selectValue1 = $("#keyword").val();

    	   location.href = "${pageContext.request.contextPath}/tie/sousou.do?page=1&mysle="+selectValue+"&keyword="+selectValue1;
   }
});
</script>
</html>
